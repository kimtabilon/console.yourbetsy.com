...
@section('breadcrumb')
<a class="navbar-brand" href="/vendor/return-policy">Update Return Policy<div class="ripple-container"></div></a>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" id="update_returnpolicy_frm">
                            {{-- <textarea id="summernote" name="about_us" rows="3"></textarea> --}}
                            <input type="hidden" id="return_policy" value="{{$data}}">
...
<script>
    ...
    $('#profile_item').find('#reseller_returnpolicy_subitem').addClass('active');
</script>
...
<script>
    $(document).ready(function() {
        ...
        $('#summernote').summernote('code', $("#return_policy").val());
        
    });

    $('#update_returnpolicy_frm').on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "PUT",
            url: '/vendor/return-policy/update',
            data: {return_policy: $('#summernote').summernote('code')},   
            dataType: 'json',   

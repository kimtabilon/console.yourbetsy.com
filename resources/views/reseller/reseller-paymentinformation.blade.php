...
@section('breadcrumb')
<a class="navbar-brand" href="/vendor/payment-information">Payment Information<div class="ripple-container"></div></a>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" id="update_paymentinformation_frm">
                            {{-- <textarea id="summernote" name="about_us" rows="3"></textarea> --}}
                            <input type="hidden" id="payment_information" value="{{$data}}">
...
<script>
    ...
    $('#profile_item').find('#reseller_paymentinfo_subitem').addClass('active');
</script>
...
<script>
    $(document).ready(function() {
        ...
        $('#summernote').summernote('code', $("#payment_information").val());
        
    });

    $('#update_paymentinformation_frm').on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "PUT",
            url: '/vendor/payment-information/update',
            data: {payment_information: $('#summernote').summernote('code')},   
            dataType: 'json',   

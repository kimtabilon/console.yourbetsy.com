...
class ResellersProfiles extends Model
{
    ...
    public static function resellers_infos($name) {
                ...
                ->leftJoin('resellers_about_uses', 'resellers.id', '=', 'resellers_about_uses.username_id')
                ->leftJoin('resellers_shipping_policies', 'resellers.id', '=', 'resellers_shipping_policies.username_id')
                ->leftJoin('resellers_return_policies', 'resellers.id', '=', 'resellers_return_policies.username_id')
                ->leftJoin('resellers_payment_informations', 'resellers.id', '=', 'resellers_payment_informations.username_id')
                /* ->join('resellers_email_addresses', 'resellers.id', '=', 'resellers_email_addresses.username_id')
                ->join('resellers_mobile_numbers', 'resellers.id', '=', 'resellers_mobile_numbers.username_id')
                ->join('resellers_addresses', 'resellers.id', '=', 'resellers_addresses.username_id')
